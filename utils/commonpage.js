...
var commonPage = function () {
  ...
  async function clearText(locator) {
    ...
    return new Promise(async function (resolve, reject) {
      try {
        currentlocator = await getElementUsing(locator);
        await currentlocator.clearValue();
        resolve(true);
      } catch (e) {
  ...
  async function getText(locator) {
    ...
    return new Promise(async function (resolve, reject) {
      try {
        currentlocator = await getElementUsing(locator);
        let elementText =  await currentlocator.getText();
        resolve(elementText);
      } catch (e) {
  ...
  async function switchToWebView() {
    return new Promise(async function (resolve, reject) {
      try {
        ...
        console.log("Error while swithcing to webview", e);
        reject(false);
      }
    });
  }
  ...
  async function isClickable(locator) {
    ...
    return new Promise(async function (resolve, reject) {
      try {
        let element_name = await getElementUsing(locator);
        const isPresent =  await element_name.isClickable();
        resolve(isPresent);
      } catch (e) {
        console.log("Error while checking the element is clickable" + locator, e);
        reject(false);
      }
    });
  }
  
  async function waitForElement(locator,waitTimeInMilliSeconds) {
    console.log("locator" + locator);
    let element_name;
    return new Promise(async function (resolve, reject) {
      try {
         element_name = await getElementUsing(locator);
        await element_name.waitForDisplayed(waitTimeInMilliSeconds * 1000);
        resolve(true);
      } catch (e) {
  ...
  async function scrollToElementbyText(text) { 
    ...
    return new Promise(async function (resolve, reject) {
      try {
        let textlocator = `android=new UiScrollable(new UiSelector().scrollable(true)).scrollTextIntoView("${text}")`;
        await $(textlocator);
        resolve();
      } catch (e) {
        console.log("Error while scrolling to the element text" + text, e);
        reject();
      }
    });
  }
  ...
  //Parameter      	   : Locator
  //########################################################################################################
    async function mousemoveTo(locator,Xcord,Ycord) {
      //wdio
      console.log("locator" + locator);
      let currentlocator;
      return new Promise(async function (resolve, reject) {
        try {
          currentlocator = await getElementUsing(locator);
          await currentlocator.moveTo(Xcord,Ycord);
          resolve();
        } catch (e) {
  ...
  //########################################################################################################
  async function singleTap(Xcord,Ycord) {
    //wdio
    return new Promise(async function (resolve, reject) {
      try {
  ...
  //########################################################################################################
  async function touchDown(Xcord,Ycord) {
    //wdio
    return new Promise(async function (resolve, reject) {
      try {
        await driver.touchDown(Xcord,Ycord);
        resolve();
      } catch (e) {
  ...
  //########################################################################################################
  async function touchUp(Xcord,Ycord) {
    //wdio
    return new Promise(async function (resolve, reject) {
      try {
        await driver.touchUp(Xcord,Ycord);
        resolve();
      } catch (e) {
  ...
  //########################################################################################################
  async function fingerScroll(locator,Xcord,Ycord) {
    //wdio
    console.log("locator" + locator);
    let currentlocator;
    return new Promise(async function (resolve, reject) {
      try {
        currentlocator = await getElementUsing(locator);
       await driver.touchScroll(Xcord,Ycord, currentlocator);
        resolve();
      } catch (e) {
  ...
  //####################################################################################################
  //Function Name		   : fingerScroll
  //Description      	 :Scroll on the touch screen for vertical scroll
  //########################################################################################################
  async function verticalScroll(Xcord,Ycord) {
    //wdio
    return new Promise(async function (resolve, reject) {
      try {
       await driver.touchScroll(Xcord,Ycord);
        resolve();
      } catch (e) {
        console.log("Error while vertical scrolling");
        reject();
      }
    });
  }
...
//Device Activity
  ...
  //####################################################################################################
  //Function Name		   : startActivity
  //Description      	 : Start an Android activity by providing package name and activity name.
  //Parameters : Mandatory : appPackage, appActivity, appWaitPackage, 
  //               Optional : appWaitActivity, intentAction, intentCategory, intentFlags, optionalIntentArguments, dontStopAppOnReset)  
  //########################################################################################################
  async function startActivity(appPackage,appActivity) {
    //wdio
    return new Promise(async function (resolve, reject) {
      try {
  ...
  async function queryAppState(queryAppState) {
    ...
    return new Promise(async function (resolve, reject) {
      try {
        let queryAppState1 =  await driver.queryAppState(queryAppState);
        resolve(queryAppState1);
      } catch (e) {
  ...
  return {
    ...
    clearText:clearText,
    getText:getText,
    scrollToElementbyText:scrollToElementbyText,
    ...
    switchToWebView:switchToWebView
  };
};
